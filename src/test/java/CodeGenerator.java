...
import static com.coffeewx.core.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/coffeewx-admin";
...
//        genCodeByCustomModelName("sys_user_role","UserRole");
        ...
        //genCode("t_third_login","ThirdLogin");
        //genCodeByCustomModelName("输入表名","输入自定义Model名称");
        //genCodeByCustomModelName("t_user","User");
        //genCodeByCustomModelName("t_account_fans","AccountFans");
        //genCodeByCustomModelName("t_third_login","ThirdLogin");
        //genModelAndMapper( "user","User" );
        //genCodeByCustomModelName("t_article","Article");
        //genCodeByCustomModelName("t_article_photo","ArticlePhoto");
        //genCodeByCustomModelName("t_photo","Photo");
        //genCodeByCustomModelName("t_user_collection","UserCollection");
    }
